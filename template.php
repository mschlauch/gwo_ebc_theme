...
/**
 * The default group for ebc framework CSS files added to the page.
 */
 ...
 */
function ebc_preprocess_html(&$vars) {
 ...
 */
function ebc_preprocess_page(&$vars, $hook) {
 ...
 * release of ebc warts and all. Future versions will make this obsolete.
 */
function ebc_css_alter(&$css) {
...
function ebc_entity_translation_unavailable($variables) {
